...
CREATE TABLE "new_League" (
    ...
    "handicapPercentage" REAL NOT NULL DEFAULT 100,
    "handicapMaxStrokes" REAL,
    "handicapAllowanceType" TEXT NOT NULL DEFAULT 'full',
...
INSERT INTO "new_League" ("adminPassword", "adminUsername", "billingEmail", "contactEmail", "contactPhone", "courseLocation", "courseName", "createdAt", "description", "endDate", "entryFee", "expiresAt", "handicapBaseScore", "handicapDefault", "handicapMax", "handicapMultiplier", "handicapRounding", "id", "maxTeams", "name", "numberOfWeeks", "playDay", "playTime", "prizeInfo", "registrationOpen", "slug", "startDate", "status", "subscriptionTier", "updatedAt") SELECT "adminPassword", "adminUsername", "billingEmail", "contactEmail", "contactPhone", "courseLocation", "courseName", "createdAt", "description", "endDate", "entryFee", "expiresAt", "handicapBaseScore", "handicapDefault", "handicapMax", "handicapMultiplier", "handicapRounding", "id", "maxTeams", "name", "numberOfWeeks", "playDay", "playTime", "prizeInfo", "registrationOpen", "slug", "startDate", "status", "subscriptionTier", "updatedAt" FROM "League";
DROP TABLE "League";
